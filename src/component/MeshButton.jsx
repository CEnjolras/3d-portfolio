  ...
  return (
    <Html distanceFactor={distanceFactor || 10} {...props}>
      ...
      >
        ...
        {label && (
          <div className="hidden group-hover:flex group-hover:opacity-100 opacity-0 transition-opacity absolute -top-8 left-4 right-0 bottom-0 z-10  items-center justify-center text-white text-xs lg:text-sm underline font-bold underline-offset-2  hover:opacity-100">
            {label}
          </div>
        )}
        {children}
